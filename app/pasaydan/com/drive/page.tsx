  ...
  return (
    <div className="w-[90%] min-h-full md:flex md:flex-row flex-col-reverse flex gap-10 justify-center items-start">
      <div
        ...
        className="md:w-[25%] md:min-h-screen pr-2 flex pb-20 flex-col gap-5 justify-start items-start"
      >
        <div className="w-full min-h-full">
          <CalendarComponent />
        </div>
      </div>
      <div className="md:w-[75%] w-fit h-full flex flex-col gap-10 justify-start items-start">
        ...
        <div className="md:w-full min-h-fit mb-10 flex flex-wrap gap-2">
          <DriveCards />
          <DriveAccordian />
        </div>
      </div>
