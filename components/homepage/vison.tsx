...
export default function Vision() {
  ...
  return (
    <div className="w-[80%] h-fit gap-6 mt-20 mb-10 flex flex-col justify-center items-center">
      ...
      <div className="w-full flex justify-center items-center gap-3 flex-wrap">
        {cardsDict.map((cards, index) => (
          <Card
            key={index}
            className="w-[300px] md:w-[400px] h-auto shadow-lg hover:shadow-xl transition-shadow"
          >
